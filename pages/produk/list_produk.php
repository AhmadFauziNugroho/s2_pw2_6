...
<a class="btn btn-primary" href="../../proces/produk/edit_produk.php?idedit=<?=$row['id']?>">Edit</a>
<a class="btn btn-primary" href="../../proces/produk/delete_produk.php?delete=<?=$row['id']?>"
