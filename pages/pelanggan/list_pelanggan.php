...
<a class="btn btn-primary" href="../../proces/pelanggan/edit_pelanggan.php?idedit=<?=$row['id']?>">Edit</a>
<a class="btn btn-primary" href="../../proces/pelanggan/delete_pelanggan.php?delete=<?=$row['id']?>"
